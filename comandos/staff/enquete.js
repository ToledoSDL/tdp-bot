...
exports.run = async (client, message, args, ops) => {
    ...
    const embed = new Discord.RichEmbed()
        ...
        .setTimestamp()
        client.channels.get(`707263054601257001`).send('<@706550764163694752>').then(msg => msg.delete(5000))

    let msg = await client.channels.get(`707263054601257001`).send(embed)
